	...
	*________________________________________________________________________________________________________________________________*
		...
		global longterm_outcomes   		"lowersec_degree yrs_school working pwork_formal lnwage_hour"							//long-term outcomes
		...
		global covariates 				mom_yrs_school hh_size																	//covariates Piza/Portela used for balance tests						
		...
		global bargain_controls_our_def region1 region2 region3 region4 white		   pardo		  hh_head_edu 		  hh_head_male hh_head_age		   adults_income		 urban hh_size         //Covariates used by Bargain/Boutin (2021) Paper
